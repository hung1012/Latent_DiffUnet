...
class PolypTrainer(Trainer):
    ...
    def training_step(self, batch):
        ...
        x_start = self.vae_model.encode(mask).sample()  # latent sample
        x_start = (x_start) * 2 - 1
    ...
    def validation_step(self, batch):
        ...
        # output = torch.sigmoid(ouput_mask)
    ...
    def validation_end(self, mean_val_outputs):
        # mean_val_outputs = mean_val_outputs[0]

        self.log("valid_loss", mean_val_outputs, step=self.epoch)
...
if __name__ == "__main__":
    ...
    logdir = "/home/admin_mcn/minhtx/logs_polyp/ldm"
    ...
    train_ds, val_ds, test_ds = get_loader_polyp(data_dir=data_dir, batch_size=batch_size, fold=0)
